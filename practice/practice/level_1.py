...
client_A = {
    "name": "my PC",
    "interface": "A1",
    "IP": "104.93.23.285", # can be modified
    "Mask": "255.255.255.0"
}
...
client_D = {
    ...
    "interface": "D1",
    "IP": "211.190.319.42", # can be modified
    "Mask": "255.255.0.0"
}
...
# Modifying IP addresses for 
# client_A to match subnet of client_B and
# client_D to match subnet of client_C
# for communication to happen successfuly 
...
This masks the first 24 bits of the IP address, 
...
This masks the first 16 bits of the IP address, 
leaving the last 16 bits for host addresses. 
